...
data class GroupResponse(
    ...
    companion object {
        fun fromDomain(group: Group): GroupResponse = GroupResponse(
            id = group.id,
...
data class AddMemberRequest(
    ...
    fun toDomain(groupId: UUID): GroupMember = GroupMember(
        groupId = groupId,
        memberId = memberId,
...
data class GroupMemberResponse(
    ...
    companion object {
        fun fromDomain(member: GroupMember): GroupMemberResponse = GroupMemberResponse(
            id = member.id,
