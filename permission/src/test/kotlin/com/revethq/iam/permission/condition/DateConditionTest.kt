...
class DateConditionTest {
    ...
    fun `DateEquals`() {
        ...
        assertTrue(
            ConditionEvaluator.evaluate(conditions, ConditionContext(customVariables = mapOf("customKey" to "2026-01-15T12:00:00Z"))),
        )
        assertFalse(
            ConditionEvaluator.evaluate(conditions, ConditionContext(customVariables = mapOf("customKey" to "2026-01-15T12:00:01Z"))),
        )
    }
    ...
    fun `DateLessThan`() {
        ...
        assertTrue(
            ConditionEvaluator.evaluate(conditions, ConditionContext(customVariables = mapOf("customKey" to "2026-01-15T11:59:59Z"))),
        )
        assertTrue(
            ConditionEvaluator.evaluate(conditions, ConditionContext(customVariables = mapOf("customKey" to "2026-01-14T12:00:00Z"))),
        )
        assertFalse(
            ConditionEvaluator.evaluate(conditions, ConditionContext(customVariables = mapOf("customKey" to "2026-01-15T12:00:00Z"))),
        )
    ...
    fun `DateGreaterThan`() {
        ...
        assertTrue(
            ConditionEvaluator.evaluate(conditions, ConditionContext(customVariables = mapOf("customKey" to "2026-01-16T12:00:00Z"))),
        )
        assertFalse(
            ConditionEvaluator.evaluate(conditions, ConditionContext(customVariables = mapOf("customKey" to "2026-01-15T12:00:00Z"))),
        )
